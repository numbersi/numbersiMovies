...
async function isVaildPlayUrl(playUrl){
    console.log('开始验证');
    const arr = 'https://1251883823.vod2.myqcloud.com/9dae6688vodgzp1251883823/70213cda5285890781965629452/7pdYUOrVSfYA.mp4'
...
async function getPlayUrlByJiexi(options){
    ...
    let  jiekou= url.startsWith('27pan')?'https://api2.my230.com/?vid=':'http://api.bbbbbb.me/jx/?url='  
    console.log('接口爬去',jiekou);
